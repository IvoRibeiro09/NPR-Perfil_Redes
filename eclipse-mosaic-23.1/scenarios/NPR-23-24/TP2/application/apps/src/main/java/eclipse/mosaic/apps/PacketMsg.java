...
public final class PacketMsg extends V2xMessage {
    ...
    public PacketMsg(MessageRouting routing, String name, String route, Double x, Double y, Double velo, int msgN, int hops) {
        super(routing);
        this.name = name;
        this.route = route;
        this.lon = x;
    ...
    public PacketMsg(MessageRouting routing, PacketMsg other) {
        super(routing);
    ...
    public String toString() {
        ...
        sb.append(" Velocity= ").append(velo);
